...
public class sender 
{
   ...
   while (true) 
   {
      ...
      { // Is the window not full and the EOT packet not sent yet?
         ...
         if (numOfCharsRead == -1) 
         { 
            // Creates an EOT packet with the next sequence number to send to the emulator
